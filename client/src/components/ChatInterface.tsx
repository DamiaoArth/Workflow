  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50">
      ...
      >
        ...
        {messages.length === 0 && (
          <div className="bg-gray-100 rounded-lg p-3 max-w-3xl mx-auto">
          ...
          return (
            <div key={msg.id} className={containerClass}>
              <div className={messageClass}>
                ...
                {/* Render code snippets if present in metadata */}
                {msg.metadata && msg.metadata.codeSnippet && (
                  <div className="bg-gray-800 text-green-400 p-2 rounded-md text-xs font-mono mt-2 overflow-x-auto">
                ...
                {msg.metadata && msg.metadata.taskUpdate && (
                  <div className="mt-2 text-xs bg-blue-50 p-2 rounded-md text-blue-800">
                    <i className="fas fa-info-circle mr-1"></i> {msg.metadata.taskUpdate}
                  </div>
                )}
              </div>
            </div>
      ...
      <div className="bg-white border-t border-gray-200 p-4">
        <div className="flex items-center">
          <div className="flex-1 relative">
            <textarea
              className="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
